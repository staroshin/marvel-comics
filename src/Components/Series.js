...
function Series() {
  ...
  const [url, setUrl] = useState('https://gateway.marvel.com:443/v1/public/series?ts=1&apikey=637fb781eb2a3ab8dea7488ffd4a826d&hash=4b650fb2fee0eef8312076da5c9c57f2');
  ...
  return (
    ...
    <Container>
      <Row className='d-flex justify-content-center'>
        <Col md={6}>
            <h1 className="text-center p-4">Best Series!</h1>
        </Col>
      </Row>
    </Container>
    <Container>
